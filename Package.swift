...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/candlefinance/candle-swift-nio-extras.git", branch: "fix-candle-1.29.0"),
        .package(url: "https://github.com/candlefinance/candle-swift-nio-transport-services.git", branch: "fix-candle-1.24.0"),
